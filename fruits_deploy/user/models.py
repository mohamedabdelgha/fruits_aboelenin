...
class ContainerItem(models.Model):  
    ...
    #     if self.container and self.container.commission and self.container.total_bill_price:
    #         commission_decimal = Decimal(self.container.commission)  
    #         total_bill_price_decimal = Decimal(self.container.total_bill_price) 
    #         return (commission_decimal / 100) * total_bill_price_decimal
    #     return None
